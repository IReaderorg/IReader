...
import ireader.core.source.model.LocalNovelDetails
...
/**
 * Android implementation of LocalCatalogSource
 * Scans local storage for novels following the Tachiyomi/Mihon folder structure
 */
class LocalSourceImpl(
    ...
    private fun getLocalDirectory(): File {
        ...
        return File(baseDir, LocalSource.LOCAL_FOLDER_NAME).apply {
            if (!exists()) mkdirs()
        }
    }
