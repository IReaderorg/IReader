...
//    private val httpClients: tachiyomi.core.http.HttpClients,
//) : CatalogLoader {
//
...
//            tachiyomi.core.prefs.PrefixedPreferenceStore(catalogPreferences, pkgName)
...
//                .newInstance(data.dependencies.apply { httpClients.default.apply { } })
//
