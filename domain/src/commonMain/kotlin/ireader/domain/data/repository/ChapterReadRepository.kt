...
/**
 * Read-only repository interface for chapter data access operations.
 * 
 * This interface provides methods for querying chapters without modification.
 * Use this interface when a component only needs to read chapter data.
 * 
 * Requirements: 9.1, 9.2, 9.3
 */
interface ChapterReadRepository {
