package ireader.core.ui.preferences
...
import ireader.core.ui.theme.prefs.asColor
import ireader.core.ui.theme.prefs.asFont
import ireader.core.ui.theme.prefs.asReaderTheme
import ireader.core.ui.theme.prefs.asVoice
...
class ReaderPreferences constructor(
    ...
    fun textAlign(): Preference<ireader.core.ui.ui.PreferenceTextAlignment> {
        return preferenceStore.getEnum(
            TEXT_ALIGNMENT,
            ireader.core.ui.ui.PreferenceTextAlignment.Left
        )
    }
