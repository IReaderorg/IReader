...
object WebViewScreenSpec : ScreenSpec {
    ...
    override val navHostRoute: String = "web_page_route/{fetchType}/{sourceId}/{chapterId}/{bookId}/{url}"
    ...
    fun buildRoute(
        ...
        return "web_page_route/$fetchType/$sourceId/${chapterId?:Constants.NULL_VALUE}/${bookId?:Constants.NULL_VALUE}/${URLEncoder.encode(url, StandardCharsets.UTF_8.name())}"
    }
