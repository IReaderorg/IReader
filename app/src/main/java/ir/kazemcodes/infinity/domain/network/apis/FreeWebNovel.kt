...
class FreeWebNovel : ParsedHttpSource() {
    ...
    override fun latestUpdatesRequest(page: Int): Request = GET("$baseUrl/latest-release-novel/$page/")
    ...
    /** **/
    override fun chapterListRequest(book: Book, page: Int): Request = GET(baseUrl+book.link.replace(".html","/$page.html"))
