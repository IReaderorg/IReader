...
class AppearanceViewModel(
    ...
    val coverBasedThemeSaturation = uiPreferences.coverBasedThemeSaturation().asState()
    val coverBasedThemeIntensity = uiPreferences.coverBasedThemeIntensity().asState()
    val coverBasedThemeTextColorMode = uiPreferences.coverBasedThemeTextColorMode().asState()
    val coverBasedThemeForLibrary = uiPreferences.coverBasedThemeForLibrary().asState()
    val coverBasedThemeSource = uiPreferences.coverBasedThemeSource().asState()
    val coverBasedThemeSurfaceTinting = uiPreferences.coverBasedThemeSurfaceTinting().asState()
    val coverBasedThemeContrast = uiPreferences.coverBasedThemeContrast().asState()
    val coverBasedThemePreset = uiPreferences.coverBasedThemePreset().asState()
    val coverBasedThemeBrightness = uiPreferences.coverBasedThemeBrightness().asState()
    val coverBasedThemeBackgroundTintOpacity = uiPreferences.coverBasedThemeBackgroundTintOpacity().asState()
    val coverBasedThemeBackdropBlur = uiPreferences.coverBasedThemeBackdropBlur().asState()
