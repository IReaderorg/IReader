...
/**
 * iOS stub implementation of PluginReflectionHelper.
 * FlareSolverr is not supported on iOS, so all methods return defaults.
 */
actual object PluginReflectionHelper {
    ...
    actual fun getDownloadStatus(plugin: Plugin): String = "Not supported on iOS"
