...
class ReaderScreenViewModel(
    ...
    companion object  {
        fun createParam(controller: Controller) : Param {
            return Param(controller.navBackStackEntry.arguments?.getLong(NavigationArgs.chapterId.name),controller.navBackStackEntry.arguments?.getLong(
                NavigationArgs.bookId.name))
        }
    }
