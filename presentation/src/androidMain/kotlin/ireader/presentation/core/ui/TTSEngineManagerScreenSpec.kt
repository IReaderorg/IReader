...
/**
 * Android implementation of Audio & Voice Studio Screen
 */
actual class TTSEngineManagerScreenSpec {
    ...
    actual fun Content() {
        ...
        AudioStudioScreen(
            ...
            onLocalServerUrlChange = { viewModel.setLocalServerUrl(it) },
            onLocalServerVoiceChange = { viewModel.setLocalServerVoice(it) },
            onLocalServerApiFormatChange = { viewModel.setLocalServerApiFormat(it) },
            onLocalServerApiKeyChange = { viewModel.setLocalServerApiKey(it) },
            onTestLocalServer = { viewModel.testLocalServerConnection() },
            onFetchLocalVoices = { viewModel.fetchLocalServerVoices() },
            onClearLocalServerError = { viewModel.clearLocalServerError() },
