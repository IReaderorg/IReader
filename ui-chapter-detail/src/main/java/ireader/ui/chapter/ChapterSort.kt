    ...
    enum class Type {
        ...
        companion object {
            fun name(type: Type): UiText {
                return when (type) {
                    Default -> UiText.StringResource(R.string.system_default)
                    ByName -> UiText.StringResource(R.string.by_name)
                    BySource -> UiText.StringResource(R.string.by_source)
                    ByChapterNumber -> UiText.StringResource(R.string.by_chapter_number)
                    Bookmark -> UiText.StringResource(R.string.by_bookmark)
                    DateFetched -> UiText.StringResource(R.string.date_fetched)
                    DateUpload -> UiText.StringResource(R.string.by_date_uploaded)
                    Read -> UiText.StringResource(R.string.by_date_read)
                }
            }
        }
    }
