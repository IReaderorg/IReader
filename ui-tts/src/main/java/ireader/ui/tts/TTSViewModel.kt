...
class TTSViewModel(
    ...
    companion object  {
        fun createParam(controller: Controller) : TTSViewModel.Param {
            return Param(controller.navBackStackEntry.arguments?.getLong("sourceId"),controller.navBackStackEntry.arguments?.getLong("chapterId"),controller.navBackStackEntry.arguments?.getLong("bookId"),controller.navBackStackEntry.arguments?.getString(NavigationArgs.readingParagraph.name))
        }
    }
