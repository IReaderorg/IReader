...
import ireader.common.models.entities.CategoryWithRelation
...
interface CategoryDao : BaseDao<Category> {
    ...
    @Transaction
    suspend fun insertOrUpdate(objList: List<ireader.common.models.entities.Category>): List<Long> {
        val insertResult = insert(objList)
        val updateList = mutableListOf<ireader.common.models.entities.Category>()
    ...
    @Transaction
    suspend fun insertOrUpdate(objList: ireader.common.models.entities.Category): Long {
