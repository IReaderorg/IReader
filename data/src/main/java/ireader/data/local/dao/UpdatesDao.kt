...
@Dao
interface UpdatesDao : BaseDao<ireader.common.models.entities.Update> {
    ...
    fun subscribeUpdates(): Flow<List<ireader.common.models.entities.UpdateWithInfo>>

    @Query("Delete FROM updates")
    suspend fun deleteAllUpdates()
    @Transaction
    suspend fun insertOrUpdate(objList: List<ireader.common.models.entities.Update>): List<Long> {
        val insertResult = insert(objList)
        val updateList = mutableListOf<ireader.common.models.entities.Update>()
    ...
    @Transaction
    suspend fun insertOrUpdate(objList: ireader.common.models.entities.Update): Long {
