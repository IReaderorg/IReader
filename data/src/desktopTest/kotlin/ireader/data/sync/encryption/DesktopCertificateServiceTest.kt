...
/**
 * Desktop-specific tests for DesktopCertificateService.
 * 
 ...
 */
class DesktopCertificateServiceTest {
    
    private lateinit var certificateService: DesktopCertificateService
    
    @Before
    fun setup() {
        certificateService = DesktopCertificateService()
    }
