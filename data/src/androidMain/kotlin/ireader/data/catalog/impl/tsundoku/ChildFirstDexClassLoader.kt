...
/**
 * A parent-last DexClassLoader for loading local tsundoku APK files.
 * Same child-first behavior as ChildFirstPathClassLoader but for DEX loading.
 */
class ChildFirstDexClassLoader(
    ...
    override fun getResourceAsStream(name: String?): InputStream? {
        return try { getResource(name)?.openStream() } catch (_: IOException) { null }
    }
}
