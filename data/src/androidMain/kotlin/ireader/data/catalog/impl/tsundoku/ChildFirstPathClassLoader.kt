 ...
 * - the parent class loader (app's shims).
 *
 * This matches tsundoku's ChildFirstPathClassLoader exactly.
 * Extension's own classes are loaded first, shared library classes
 * (source-api, Injekt, etc.) fall through to the parent (our shims).
 */
