...
import org.ireader.data.local.MIGRATION_26_27
...
class MigrationTest {
    ...
    @Test
    fun migrateTest() {
        database = helper.createDatabase(TEST_DB, 26).apply {
        ...
        // ADDED a tableId
        database = helper.runMigrationsAndValidate(TEST_DB, 27, true, MIGRATION_26_27())
