...
import org.ireader.data.local.MIGRATION_25_26
...
class MigrationTest {
    ...
    @Test
    fun migrateTest() {
        database = helper.createDatabase(TEST_DB, 25).apply {
        ...
        // ADDED a tableId
        database = helper.runMigrationsAndValidate(TEST_DB, 25, true, MIGRATION_25_26())
