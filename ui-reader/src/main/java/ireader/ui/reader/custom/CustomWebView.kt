package ireader.ui.reader.custom
...
fun WebView(
    ...
    navigator: ireader.ui.reader.custom.WebViewNavigator = rememberWebViewNavigator(),
...
) = remember(coroutineScope) { ireader.ui.reader.custom.WebViewNavigator(coroutineScope) }

open class AccompanistWebViewClient : WebViewClient() {
    open lateinit var state: WebViewState
        internal set
    open lateinit var navigator: ireader.ui.reader.custom.WebViewNavigator
        internal set
